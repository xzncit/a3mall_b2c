<?php /*a:2:{s:84:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/system/users/editor.php";i:1623379871;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <select name="role_id" lay-verify="required" lay-reqtext="请选择分组">
                                        ...
                                        <option value="<?php echo htmlentities($value['id']); ?>"<?php if(!empty($data['role_id']) && $value['id']==$data['role_id']): ?> selected<?php endif; ?>><?php echo htmlentities($value['title']); ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="email" value="<?php echo htmlentities((isset($data['email']) && ($data['email'] !== '')?$data['email']:'')); ?>" lay-reqtext="请填写邮箱" lay-verify="required" placeholder="请输入邮箱" autocomplete="off" class="layui-input">
                                </div>
                            </div>
    ...
    $(function () {
        layui.use(["form", "element",'layer','laydate'], function () {
            ...
            form.on('submit(layui-submit-filter)', function (data) {
                ...
                $.post('<?php echo url("editor"); ?>', data.field, function (result) {
                    layer.close(index);
                    if(result.code){
