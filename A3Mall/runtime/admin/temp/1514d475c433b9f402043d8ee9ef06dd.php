<?php /*a:2:{s:88:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/system/setting/delivery.php";i:1623379871;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="AppKey" value="<?php echo htmlentities((isset($data['AppKey']) && ($data['AppKey'] !== '')?$data['AppKey']:'')); ?>" lay-reqtext="请填写AppKey" lay-verify="required" placeholder="请输入AppKey" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="AppCode" value="<?php echo htmlentities((isset($data['AppCode']) && ($data['AppCode'] !== '')?$data['AppCode']:'')); ?>" lay-reqtext="请填写AppCode" lay-verify="required" placeholder="请输入AppCode" autocomplete="off" class="layui-input">
                            </div>
                        </div>
    ...
    $(function () {
        layui.use(["form", "element",'layer'], function () {
            ...
            form.on('submit(layui-submit-filter)', function (data) {
                ...
                $.post('<?php echo createUrl("delivery"); ?>', data.field, function (result) {
                    layer.close(index);
                    if(result.code){
