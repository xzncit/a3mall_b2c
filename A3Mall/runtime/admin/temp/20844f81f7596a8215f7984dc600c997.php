<?php /*a:2:{s:85:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/products/group/index.php";i:1623379871;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <div class="col-xs-12">
        <ul>
            ...
            <li><a href="javascript:;">拼团列表</a></li>
        </ul>
    </div>
</div>
...
layui.use(['table','form'], function () {
    ...
    table.render({
        ...
        , cols: [[
                ...
                , {field:"username",title:"开团团长",width:120,align:"center"}
                , {field:"start_time",title:"开团时间",width:180,align:"center"}
                , {field: 'goods_title', title: '拼团产品'}
                , {field: 'people', title: '几人团',width:100,align:'center',templet: function(res){
                    return res.people+"人";
                }}
                , {field: 'people_count', title: '几人参加', width: 100, align:"center",templet: function(res){
                    return res.people_count + "人";
                }}
                , {field: 'end_time', title: '结束时间', edit:true, width: 180, align:"center"}
