<?php /*a:1:{s:79:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/users/index/finance.php";i:1623379871;}*/ ?>
    ...
    <div class="layui-editor-box">
        <div class="layui-tab layui-tab-brief layui-tab-bg layui-tab-content-box">
            ...
            <form action="" class="layui-form layui-form-pane">
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <input name="id" type="hidden" value="<?php echo htmlentities((isset($user['id']) && ($user['id'] !== '')?$user['id']:'0')); ?>">
    ...
    $(function () {
        layui.use(["form", "element",'layer'], function () {
            ...
            form.on('submit(layui-submit-filter)', function (data) {
                ...
                $.post('<?php echo createUrl("finance"); ?>', data.field, function (result) {
                    layer.close(index);
                    if (result.code) {
