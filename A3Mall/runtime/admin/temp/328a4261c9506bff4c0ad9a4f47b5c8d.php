<?php /*a:2:{s:83:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/users/setting/base.php";i:1623379871;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="layui-tab-item layui-show">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="amount" value="<?php echo htmlentities((isset($data['amount']) && ($data['amount'] !== '')?$data['amount']:'0.00')); ?>" lay-reqtext="请填写提现最低金额" lay-verify="required" placeholder="请输入提现最低金额" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <textarea placeholder="请输入提现银行" name="bank" class="layui-textarea"><?php echo htmlentities((isset($data['bank']) && ($data['bank'] !== '')?$data['bank']:"")); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <textarea placeholder="请输入禁止注册用户名" name="username" class="layui-textarea"><?php echo htmlentities((isset($data['username']) && ($data['username'] !== '')?$data['username']:"")); ?></textarea>
