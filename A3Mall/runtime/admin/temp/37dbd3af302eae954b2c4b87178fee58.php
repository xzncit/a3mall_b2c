<?php /*a:2:{s:83:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/system/sms/setting.php";i:1623379871;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input style="width: 97%" type="text" name="accessKeyId" value="<?php echo htmlentities((isset($data['accessKeyId']) && ($data['accessKeyId'] !== '')?$data['accessKeyId']:'')); ?>" lay-reqtext="请填写accessKeyId" lay-verify="required" placeholder="请输入accessKeyId" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input style="width: 97%" type="text" name="accessSecret" value="<?php echo htmlentities((isset($data['accessSecret']) && ($data['accessSecret'] !== '')?$data['accessSecret']:'')); ?>" lay-reqtext="请填写accessSecret" lay-verify="required" placeholder="请输入accessSecret" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input style="width: 97%" type="text" name="duration_time" value="<?php echo htmlentities((isset($data['duration_time']) && ($data['duration_time'] !== '')?$data['duration_time']:'5')); ?>" lay-reqtext="请填写验证码有效期" lay-verify="required" placeholder="请输入验证码有效期" autocomplete="off" class="layui-input">
                                </div>
