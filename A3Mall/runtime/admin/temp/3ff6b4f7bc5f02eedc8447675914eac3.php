<?php /*a:2:{s:84:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/users/setting/index.php";i:1625180922;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <select name="type">
                                    <option value="0" <?php if(isset($data['type']) && $data['type'] == 0): ?>selected<?php endif; ?>>关闭分销</option>
                                    <option value="1" <?php if(isset($data['type']) && $data['type'] == 1): ?>selected<?php endif; ?>>人人分销</option>
                                    <option value="2" <?php if(isset($data['type']) && $data['type'] == 2): ?>selected<?php endif; ?>>指定分销</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="radio" name="is_goods_rebate" value="1" title="开启" <?php if(isset($data['is_goods_rebate']) && $data['is_goods_rebate'] == 1): ?>checked<?php endif; ?>>
                                <input type="radio" name="is_goods_rebate" value="0" title="关闭" <?php if(empty($data['is_goods_rebate']) || $data['is_goods_rebate'] == 0): ?>checked<?php endif; ?>>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="one" value="<?php echo htmlentities((isset($data['one']) && ($data['one'] !== '')?$data['one']:'0')); ?>" lay-reqtext="请填写一级返佣比例" lay-verify="required" placeholder="请输入一级返佣比例" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="two" value="<?php echo htmlentities((isset($data['two']) && ($data['two'] !== '')?$data['two']:'0')); ?>" lay-reqtext="请填写二级返佣比例" lay-verify="required" placeholder="请输入二级返佣比例" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="three" value="<?php echo htmlentities((isset($data['three']) && ($data['three'] !== '')?$data['three']:'0')); ?>" lay-reqtext="请填写三级返佣比例" lay-verify="required" placeholder="请输入三级返佣比例" autocomplete="off" class="layui-input">
                            </div>
                        </div>
