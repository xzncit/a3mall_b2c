<?php /*a:2:{s:87:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/system/setting/address.php";i:1623379871;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="name" value="<?php echo htmlentities((isset($data['name']) && ($data['name'] !== '')?$data['name']:'')); ?>" lay-reqtext="请填写网站名称" lay-verify="required" placeholder="请输入网站名称" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="full_name" value="<?php echo htmlentities((isset($data['full_name']) && ($data['full_name'] !== '')?$data['full_name']:'')); ?>" lay-reqtext="请填写联系人姓名" lay-verify="required" placeholder="请输入联系人姓名" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="mobile" value="<?php echo htmlentities((isset($data['mobile']) && ($data['mobile'] !== '')?$data['mobile']:'')); ?>" lay-reqtext="请填写手机号" lay-verify="required" placeholder="请输入手机号" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="phone" value="<?php echo htmlentities((isset($data['phone']) && ($data['phone'] !== '')?$data['phone']:'')); ?>" placeholder="请输入电话" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block">
                                <textarea name="address" placeholder="请输入完整地址" class="layui-textarea"><?php echo htmlentities((isset($data['address']) && ($data['address'] !== '')?$data['address']:"")); ?></textarea>
                            </div>
                        </div>
    ...
    $(function () {
        layui.use(["form", "element",'layer'], function () {
            ...
            form.on('submit(layui-submit-filter)', function (data) {
                ...
                $.post('<?php echo createUrl("address"); ?>', data.field, function (result) {
                    layer.close(index);
                    if(result.code){
