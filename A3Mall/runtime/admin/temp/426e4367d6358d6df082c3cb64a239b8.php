<?php /*a:2:{s:90:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/products/index/editor_regiment.php";i:1623379871;s:71:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/main/layout.php";i:1623379870;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="layui-input-block">
                            <table style='width: 100%;' class="layui-table">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="limit_min_count" value="<?php echo htmlentities((isset($data['limit_min_count']) && ($data['limit_min_count'] !== '')?$data['limit_min_count']:1)); ?>" required  lay-verify="required" placeholder="请输入最小团购数量" autocomplete="off" class="layui-input"></td>
                                    <td><input type="text" name="limit_max_count" value="<?php echo htmlentities((isset($data['limit_max_count']) && ($data['limit_max_count'] !== '')?$data['limit_max_count']:3)); ?>" required  lay-verify="required" placeholder="请输入最大团购数量" autocomplete="off" class="layui-input"></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    $(function () {
        ...
        layui.use(["form", "element",'layer','laydate'], function () {
            ...
            form.on('submit(layui-submit-filter)', function (data) {
                ...
                $.post('<?php echo createUrl("editor_regiment"); ?>', data.field, function (result) {
                    layer.close(index);
                    if(result.code){
