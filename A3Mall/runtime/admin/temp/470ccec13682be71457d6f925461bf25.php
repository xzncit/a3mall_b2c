<?php /*a:2:{s:86:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/statistics/data/order.php";i:1623379871;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script src="/static/system/js/echarts/map/js/china.js"></script>
<style type="text/css">
    .echarts-box {
        width: 97.5%;
        height: 100%;
    ...
    <div class="layui-fluid" id="search-box">
        <div class="layui-card">
            <div class="layui-card-body">
                <form method="post" class="layui-form layui-form-pane" action="<?php echo url('order'); ?>">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline seller-inline-4">
                                <input id="start-time-box" type="text" name="start_time" value="<?php echo htmlentities((isset($start_time) && ($start_time !== '')?$start_time:'')); ?>" placeholder="请输入开始时间" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline seller-inline-4">
                                <input id="end-time-box" type="text" name="end_time" value="<?php echo htmlentities((isset($end_time) && ($end_time !== '')?$end_time:'')); ?>" placeholder="请输入结束时间" autocomplete="off" class="layui-input">
                            </div>
                        </div>
        ...
        series: [
            {
                ...
                data:[
                    ...
                    {name: '<?php echo $item["name"]; ?>',value: <?php echo $item["num"]; ?> }<?php echo $i+1!=$count ? ',' : ''; $i++; endforeach; endif; ?>
                ]
            }
        ]
    };
