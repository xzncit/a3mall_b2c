<?php /*a:2:{s:84:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/service/index/index.php";i:1624064190;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="row content-nav">
    <div class="col-xs-12">
        <ul>
            ...
            <li><a href="javascript:;">客服列表</a></li>
        </ul>
    </div>
</div>
    ...
    layui.config({
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field:'online', title:'是否在线', width:120,align:"center",templet: function(res){
                        switch(res.online){
                            case 0:
                                return "<span style='color:green;'>在线</span>";
                            case 1:
                                return "<span style='color:#FFB800;'>离线</span>";
                        }
                    }}
                , {field:'status', title:'状态', width:60,align:"center",templet: function(res){
                        switch(res.status){
                            ...
                            case 1:
                                return "<span style='color:#FFB800;'>禁用</span>";
                        }
                    }}
                , {field: 'format_last_online_time', title: '登录时间', width: 180, align: "center"}
