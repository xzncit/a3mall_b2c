<?php /*a:2:{s:85:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/system/setting/email.php";i:1623379871;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="address" value="<?php echo htmlentities((isset($data['address']) && ($data['address'] !== '')?$data['address']:'')); ?>" lay-reqtext="请填写SMTP地址" lay-verify="required" placeholder="请输入SMTP地址" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="port" value="<?php echo htmlentities((isset($data['port']) && ($data['port'] !== '')?$data['port']:'')); ?>" lay-reqtext="请填写SMTP端口" lay-verify="required" placeholder="请输入SMTP端口" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="username" value="<?php echo htmlentities((isset($data['username']) && ($data['username'] !== '')?$data['username']:'')); ?>" lay-reqtext="请填写邮箱用户名" lay-verify="required" placeholder="请输入邮箱用户名" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="password" value="<?php echo htmlentities((isset($data['password']) && ($data['password'] !== '')?$data['password']:'')); ?>" lay-reqtext="请填写SMTP密码" lay-verify="required" placeholder="请输入SMTP密码" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="smtp_name" value="<?php echo htmlentities((isset($data['smtp_name']) && ($data['smtp_name'] !== '')?$data['smtp_name']:'')); ?>" lay-reqtext="请填写收发送者名称" lay-verify="required" placeholder="请输入收发送者名称" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="smtp_send" value="<?php echo htmlentities((isset($data['smtp_send']) && ($data['smtp_send'] !== '')?$data['smtp_send']:'')); ?>" lay-reqtext="请填写发件人邮箱" lay-verify="required" placeholder="请输入发件人邮箱" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="radio" name="is_ssl" title="启用" value="0" <?php if(empty($data['is_ssl']) || $data['is_ssl']==0): ?>checked="checked"<?php endif; ?>>
                                    <input type="radio" name="is_ssl" title="关闭" value="1" <?php if(isset($data['is_ssl']) && $data['is_ssl']==1): ?>checked="checked"<?php endif; ?>>
                                </div>
                            </div>
                    </div>
    ...
    $(function () {
        layui.use(["form", "element",'layer'], function () {
            ...
            form.on('submit(layui-submit-filter)', function (data) {
                ...
                $.post('<?php echo createUrl("email"); ?>', data.field, function (result) {
                    layer.close(index);
                    if(result.code){
