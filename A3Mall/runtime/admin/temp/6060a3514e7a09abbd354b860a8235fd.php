<?php /*a:2:{s:81:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/card/order/index.php";i:1623379870;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <div class="col-xs-12">
        <ul>
            <li><a href="javascript:;"><i></i>&nbsp;卡劵管理</a></li>
...
<script type="text/html" id="list-bar">
    <a class="layui-btn layui-btn-xs layui-bg-gray" lay-event="detail">物流</a>
    ...
    layui.use(['table','form'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'distribution_status', title: '发货状态',align:"center",templet: function (res) {
                    if(res.distribution_status == 0){
                        return "未发货";
                    }
                ...
                , {fixed: 'right', align: 'center', title: '操作', templet: function(res){
                        var str = '';
                        if(res.distribution_status == 1 && res.distribution_code != ''){
