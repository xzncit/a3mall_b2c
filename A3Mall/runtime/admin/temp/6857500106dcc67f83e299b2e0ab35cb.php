<?php /*a:2:{s:84:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/users/finance/apply.php";i:1623379871;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    table.on('tool(list-box)', function (obj) {
        ...
        if (obj.event === 'handle') {
            layer.open({
                ...
                shade: 0.3,
                area: ['60%', '80%'],
                content: '<?php echo createUrl("handle"); ?>?id='+data.id
            });
        }
    });
