<?php /*a:2:{s:91:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/statistics/search/detailed.php";i:1623379871;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    layui.use(['table','form',"layer"], function () {
        ...
        table.render({
            elem: '#list-box'
            , url: '<?php echo createUrl("detailed"); ?>'
                ...
                case 'clear':
                    layer.msg('你确定要清空所有统计数据吗？', {
                        ...
                        ,yes: function(index){
                            layer.close(index);
                            layer.load();
                            $.get("<?php echo createUrl('detailed_clear'); ?>",function(result){
                                if(result.code){
