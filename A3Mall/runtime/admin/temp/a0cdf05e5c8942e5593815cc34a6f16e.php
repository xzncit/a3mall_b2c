<?php /*a:2:{s:86:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/platform/navigation/editor.php";i:1623379871;s:71:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/main/layout.php";i:1623379870;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="url" value="<?php echo htmlentities((isset($data['url']) && ($data['url'] !== '')?$data['url']:'')); ?>" lay-reqtext="请填写地址" lay-verify="required" placeholder="请输入地址" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="radio" name="target" title="本窗口" value="0" <?php if(empty($data['target']) || $data['target']==0): ?>checked="checked"<?php endif; ?>>
                                    <input type="radio" name="target" title="新窗口" value="1" <?php if(isset($data['target']) && $data['target']==1): ?>checked="checked"<?php endif; ?>>
                                </div>
                            </div>
