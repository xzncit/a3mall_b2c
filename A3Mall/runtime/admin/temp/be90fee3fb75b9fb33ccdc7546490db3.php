<?php /*a:3:{s:76:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/wechat/index/pay.php";i:1623379871;s:71:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/main/layout.php";i:1623379870;s:85:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/wechat/common/wechat_menu.php";i:1623379871;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div class="layui-tab-item layui-show">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="mch_id" value="<?php echo htmlentities((isset($data['mch_id']) && ($data['mch_id'] !== '')?$data['mch_id']:'')); ?>" lay-reqtext="请填写微信商户编号" lay-verify="required" placeholder="请输入微信商户编号" autocomplete="off" class="layui-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" name="mch_key" value="<?php echo htmlentities((isset($data['mch_key']) && ($data['mch_key'] !== '')?$data['mch_key']:'')); ?>" lay-reqtext="请填写微信商户密钥" lay-verify="required" placeholder="请输入微信商户密钥" autocomplete="off" class="layui-input">
                                        </div>
                                    </div>
