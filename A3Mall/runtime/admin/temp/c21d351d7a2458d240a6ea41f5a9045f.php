<?php /*a:2:{s:87:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/products/index/editor_group.php";i:1623379871;s:71:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/main/layout.php";i:1623379870;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <div class="col-xs-12">
        <ul>
            ...
            <li><a href="javascript:;">拼团活动</a></li>
        </ul>
    </div>
</div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <table style='width: 100%;' class="layui-table">
                                ...
                                <thead>
                                <tr>
                                    <th style="text-align:center;">拼团价格</th>
                                    <th style="text-align:center;">参团人数</th>
                                    <th style="text-align:center;">有效时长（小时）</th>
                                ...
                                <tbody>
                                <tr>
                                    <td><input type="text" name="sell_price" value="<?php echo htmlentities((isset($data['sell_price']) && ($data['sell_price'] !== '')?$data['sell_price']:$data['goods']['sell_price'])); ?>" required  lay-verify="required" placeholder="请输入拼团价格" autocomplete="off" class="layui-input"></td>
                                    <td><input type="text" name="people" value="<?php echo htmlentities((isset($data['people']) && ($data['people'] !== '')?$data['people']:'2')); ?>" required  lay-verify="required" placeholder="请输入参团人数" autocomplete="off" class="layui-input"></td>
                                    <td><input type="text" name="effective_time" value="<?php echo htmlentities((isset($data['effective_time']) && ($data['effective_time'] !== '')?$data['effective_time']:'24')); ?>" required  lay-verify="required" placeholder="请输入有效时长" autocomplete="off" class="layui-input"></td>
    ...
    $(function () {
        ...
        layui.use(["form", "element",'layer','laydate'], function () {
            ...
            form.on('submit(layui-submit-filter)', function (data) {
                ...
                $.post('<?php echo createUrl("editor_group"); ?>', data.field, function (result) {
                    layer.close(index);
                    if(result.code){
