<?php /*a:1:{s:87:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/common/index/get_goods_data.php";i:1623379870;}*/ ?>
...
<script>
    ...
    layui.use(['form', 'laydate','table'], function(){
        layui.table.render({
            ...
            page: 'true',
            limit:'10',
            url: "<?php echo createUrl('products.index/index'); ?>",
            id:'tagGoodsTable',
            cols: [[
                {type:'checkbox'}
