<?php /*a:3:{s:76:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/wechat/mini/base.php";i:1624875126;s:71:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/main/layout.php";i:1623379870;s:83:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/wechat/common/mini_menu.php";i:1623379871;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div class="layui-tab-item layui-show">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="radio" name="mini_status" title="开发版" value="developer" <?php if(empty($data['mini_status']) || $data['mini_status']=='developer'): ?>checked="checked"<?php endif; ?>>
                                            <input type="radio" name="mini_status" title="体验版" value="trial" <?php if(isset($data['mini_status']) && $data['mini_status']=='trial'): ?>checked="checked"<?php endif; ?>>
                                            <input type="radio" name="mini_status" title="正式版" value="formal" <?php if(isset($data['mini_status']) && $data['mini_status']=='formal'): ?>checked="checked"<?php endif; ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="radio" name="is_rechange" title="启用" value="0" <?php if(empty($data['is_rechange']) || $data['is_rechange']==0): ?>checked="checked"<?php endif; ?>>
                                            <input type="radio" name="is_rechange" title="关闭" value="1" <?php if(isset($data['is_rechange']) && $data['is_rechange']==1): ?>checked="checked"<?php endif; ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="radio" name="is_withdrawal" title="启用" value="0" <?php if(empty($data['is_withdrawal']) || $data['is_withdrawal']==0): ?>checked="checked"<?php endif; ?>>
                                            <input type="radio" name="is_withdrawal" title="关闭" value="1" <?php if(isset($data['is_withdrawal']) && $data['is_withdrawal']==1): ?>checked="checked"<?php endif; ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="radio" name="is_subscribe" title="启用" value="0" <?php if(empty($data['is_subscribe']) || $data['is_subscribe']==0): ?>checked="checked"<?php endif; ?>>
                                            <input type="radio" name="is_subscribe" title="关闭" value="1" <?php if(isset($data['is_subscribe']) && $data['is_subscribe']==1): ?>checked="checked"<?php endif; ?>>
                                        </div>
                                    </div>
    ...
    $(function () {
        layui.use(["form", "element",'layer'], function () {
            ...
            form.on('submit(layui-submit-filter)', function (data) {
                ...
                $.post('<?php echo createUrl("base"); ?>', data.field, function (result) {
                    layer.close(index);
                    if(result.code){
