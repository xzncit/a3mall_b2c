<?php /*a:2:{s:87:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/users/setting/register.php";i:1623379871;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-form-item">
                            <script id="container" style="width:100%;height: 500px;" name="content" type="text/plain"><?php echo (isset($data) && ($data !== '')?$data:""); ?></script>
                        </div>
    ...
    $(function () {
        ...
        layui.use(["form", "element",'layer'], function () {
            ...
            form.on('submit(layui-submit-filter)', function (data) {
                ...
                $.post('<?php echo createUrl("register"); ?>', data.field, function (result) {
                    layer.close(index);
                    if(result.code){
