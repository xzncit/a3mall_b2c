<?php /*a:2:{s:84:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/order/setting/index.php";i:1623379870;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="cancel_time" value="<?php echo htmlentities((isset($data['cancel_time']) && ($data['cancel_time'] !== '')?$data['cancel_time']:'')); ?>" lay-reqtext="请填写订单取消时间" lay-verify="required" placeholder="请输入订单取消时间" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="complete_time" value="<?php echo htmlentities((isset($data['complete_time']) && ($data['complete_time'] !== '')?$data['complete_time']:'')); ?>" lay-reqtext="请填写订单完成时间" lay-verify="required" placeholder="请输入订单完成时间" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="confirm_time" value="<?php echo htmlentities((isset($data['confirm_time']) && ($data['confirm_time'] !== '')?$data['confirm_time']:'')); ?>" placeholder="请输入订单确认收货时间" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                    </div>
