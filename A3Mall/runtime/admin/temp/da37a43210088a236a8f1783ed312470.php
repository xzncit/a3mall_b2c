<?php /*a:2:{s:78:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/users/setting/sign.php";i:1623379871;s:71:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/main/layout.php";i:1623379870;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <select name="status">
                                    <option value="0" <?php if(isset($data['status']) && $data['status'] == 0): ?>selected<?php endif; ?>>关闭</option>
                                    <option value="1" <?php if(isset($data['status']) && $data['status'] == 1): ?>selected<?php endif; ?>>开启</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div>
                            <table class="layui-table">
                                ...
                                <tr>
                                    <td>
                                        <input type="text" name="list[name][]" value="<?php echo htmlentities($item['name']); ?>" placeholder="请输入名称" autocomplete="off" class="layui-input">
                                    </td>
                                    <td>
                                        <input type="text" name="list[point][]" value="<?php echo htmlentities($item['point']); ?>" placeholder="请输入积分" autocomplete="off" class="layui-input">
                                    </td>
                                    <td>
                        ...
                        <div class="layui-form-item">
                            <script id="container" style="width:100%;height: 500px;" name="content" type="text/plain"><?php echo (isset($content) && ($content !== '')?$content:""); ?></script>
    ...
    $(function () {
        ...
        layui.use(["form", "element",'layer'], function () {
            ...
            form.on('submit(layui-submit-filter)', function (data) {
                ...
                $.post('<?php echo createUrl("sign"); ?>', data.field, function (result) {
                    layer.close(index);
                    if(result.code){
