<?php /*a:2:{s:78:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/service/chat/index.php";i:1623760982;s:71:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/main/layout.php";i:1623379870;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="row content-nav">
    <div class="col-xs-12">
        <ul>
            <li><a href="javascript:;"><i></i>&nbsp;记录管理</a></li>
    ...
    layui.config({
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'send_name', title: '发送者',width:140,align:"center"}
                , {field: 'to_name', title: '接收者',width:140,align:"center"}
                , {field: 'content', title: '内容',templet: function(res){
                        switch(res.type){
                            case "text":
                                return "<span>"+res.content+"</span>";
                            case "image":
                                return "<span><img src='"+res.content+"' style='max-width:30px; max-height:30px;'></span>";
                            case "goods":
                                return "<span>商品推送</span>";
                            case "order":
                                return "<span>订单推送</span>";
                        }
                    }}
                , {field:'is_read', title:'是否己读', width:120,align:"center",templet: function(res){
                        switch(res.is_read){
                            case 0:
                                return "<span>未读</span>";
                            case 1:
                                return "<span style='color:green;'>己读</span>";
                        }
                    }}
                , {field: 'format_create_time', title: '发送时间', width: 180, align: "center"}
