<?php /*a:1:{s:76:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/common/get_users.php";i:1625289058;}*/ ?>
...
<script>
    layui.use(['table','layer','form'], function () {
        ...
        table.render({
            elem: '#list-box'
            , url: '<?php echo createUrl("common.ajax/get_users"); ?>'
        ...
        table.on('tool(list-box)', function (obj) {
            ...
            if (obj.event === 'selected') {
                layer.confirm('您确定要将该会员设置成推广员吗？', {
                    ...
                    $.get("<?php echo createUrl('users.spread/add'); ?>",{ id: data.id },function (res){
