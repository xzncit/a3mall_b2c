<?php /*a:2:{s:81:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/service/setting/index.php";i:1623765265;s:71:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/main/layout.php";i:1623379870;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <div class="col-xs-12">
        <ul>
            <li><a href="javascript:;"><i></i>客服设置</a></li>
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <div class="layui-form-item">
                            <label class="layui-form-label">客服分配</label>
                            <div class="layui-input-block">
                                <select name="type">
                                    <option value="0" <?php if(isset($data['type']) && $data['type'] == 0): ?>selected<?php endif; ?>>智能分配</option>
                                </select>
                            </div>
                        </div>
