<?php /*a:2:{s:80:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/products/index/index.php";i:1623379871;s:71:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/admin/view/main/layout.php";i:1623379870;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <select name="cat_id">
                            ...
                            <option value="<?php echo htmlentities($value['id']); ?>"><?php echo $value['level']; ?><?php echo $value['title']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <?php endif; ?>
                        </select>   
                        </div>
...
layui.config({
    ...
    table.on('toolbar(list-box)', function (obj) {
        switch (obj.event) {
            case 'export':
                window.location.href = '<?php echo createUrl("export"); ?>';
                break;
            case 'url':
    ...
    table.on('tool(list-box)', function (obj) {
        ...
        if (obj.event === 'del') {
            ...
            window.location.href = '<?php echo createUrl("editor_group"); ?>?id='+data.id;
        }else if(obj.event == 'regiment'){
            window.location.href = '<?php echo createUrl("editor_regiment"); ?>?id='+data.id;
        }else if(obj.event == 'second'){
            window.location.href = '<?php echo createUrl("editor_second"); ?>?id='+data.id;
        }else if(obj.event == 'point'){
            window.location.href = '<?php echo createUrl("editor_point"); ?>?id='+data.id;
        }
    });
