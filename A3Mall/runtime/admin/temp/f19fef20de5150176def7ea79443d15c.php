<?php /*a:2:{s:84:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/products/area/index.php";i:1623379871;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
layui.use(['table','form'], function () {
    ...
    table.on('tool(list-box)', function (obj) {
        ...
        if (obj.event === 'del') {
            ...
            window.location.href = '<?php echo createUrl("editor"); ?>?pid='+data.id;
        }
    });
