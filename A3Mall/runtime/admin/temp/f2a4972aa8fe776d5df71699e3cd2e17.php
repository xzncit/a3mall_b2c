<?php /*a:2:{s:85:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/system/payment/index.php";i:1625472654;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    layui.use(['table','form'], function () {
        ...
        table.on('tool(list-box)', function (obj) {
            ...
            switch(data.code) {
                ...
                case "wechat-h5":
                case "wechat-qrcode":
                    window.location.href = '<?php echo createUrl("wechat.index/pay"); ?>';
                    break;
                case "wechat-app":
                    window.location.href = '<?php echo createUrl("editor"); ?>?id='+data.id;
                    break;
                case "wechat-mini":
                    window.location.href = '<?php echo createUrl("wechat.mini/pay"); ?>';
                    break;
                case "alipay-app":
                case "alipay-web":
                case "alipay-wap":
