<?php /*a:2:{s:83:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/system/store/index.php";i:1623379871;s:76:"/Users/huangjiapeng/www/A3MallPro/base/A3Mall/app/admin/view/main/layout.php";i:1627731555;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <form class="layui-form" action="">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="checkbox" name="is_shipping" value="1" <?php if($checked): ?>checked<?php endif; ?> lay-filter="is_shipping" lay-skin="switch" lay-text="开启|关闭">
                </div>
            </div>
        </form>
    </div>
...
<script>
    layui.use(['table','form'], function () {
        ...
        form.on('switch(is_shipping)', function(data){
            $.post('<?php echo createUrl("index"); ?>',{ checked : data.elem.checked ? 1 : 0 },function (res) {},"json");
        });
