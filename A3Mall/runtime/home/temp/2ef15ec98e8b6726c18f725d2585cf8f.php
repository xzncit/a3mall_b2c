<?php /*a:3:{s:72:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/ucenter/point.php";i:1623379872;s:70:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/main/layout.php";i:1623379872;s:78:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/common/ucenter_menu.php";i:1623379872;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="member-container clear">
    ...
    <div class="member-sideright">
        ...
        <div class="points-container">
            <div class="points-text">我的积分：<span class="color-orage"><?php echo G("users.point"); ?> 积分</span></div>
            <div class="credits-box">
                <a href="<?php echo url('point/index'); ?>" class="credits-btn">积分兑换</a>
                <span class="witt">您可以使用积分兑换商品。</span>
            </div>
        </div>
        <!-- 我的订单 -->
        <div class="order-container">
            <div class="obder-bg"><span class="morder-title">我的积分</span></div>
            <div class="morder-center">
                <table cellspacing="0" cellpadding="0" class="morder-table">
                    ...
                    <tr>
                        ...
                        <td><span class="color-gree"><?php echo htmlentities($vo['point']); ?> 分</span></td>
