<?php /*a:2:{s:70:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/point/index.php";i:1623379872;s:70:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/main/layout.php";i:1623379872;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="title-textbox">
    <a href="/">首页</a>&nbsp;<em>/</em>
    <a href="<?php echo url('point/index'); ?>">积分商城</a>
</div>
...
<div class="list-good-wrap">
    ...
    <div class="sort-wrap">
        <ul>
            <li><a href="<?php echo url('point/index'); ?>">默认排序</a></li>
            <li class="before-arrow"><span <?php if($order == 'asc' && $sort=='price'): ?>class="arrow-ico"<?php endif; ?>><a href="<?php echo url('point/index',['sort'=>'price','order'=>$order]); ?>">价格</a></span></li>
            <li class="before-arrow"><span <?php if($order == 'asc' && $sort=='salt'): ?>class="arrow-ico"<?php endif; ?>><a href="<?php echo url('point/index',['sort'=>'salt','order'=>$order]); ?>">销量</a></span></li>
        </ul>
    </div>
            ...
            <div class="sales-ranking-text">
                <ul>
                    ...
                    <li>
                        ...
                        <p class="price-text"><?php echo htmlentities($value['point']); ?> 积分</p>
        ...
        <div class="list-goods-right">
            ...
            <div class="list-wares clear">
                <ul>
                    ...
                    <li>
                    <div class="wares-box">
                        <span><a href="<?php echo htmlentities($vo['url']); ?>"><img class="lazy" src="/static/front/images/grey.png" data-original="<?php echo htmlentities($vo['photo']); ?>" alt="" /></a></span>
                        <em class="pro-tit"><a href="<?php echo htmlentities($vo['url']); ?>" class="list-title"><?php echo htmlentities($vo['title']); ?></a></em>
                        <p class="price-text"><?php echo htmlentities($vo['point']); ?> 积分</p>
                    </div>
                    <div class="wares-center">
                        <span class="sold">已兑换 <?php echo htmlentities($vo['sum_count']); ?> 件</span>
                        <em class="exist">已有 <a href="<?php echo htmlentities($vo['url']); ?>#comment-list"><?php echo htmlentities($vo['comment_count']); ?></a> 人评价</em>
                    </div>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            ...
            <?php endif; ?>
            <div class="goods-page clear"><?php echo htmlentities($page); ?></div>
        </div>
    </div>
</div>
