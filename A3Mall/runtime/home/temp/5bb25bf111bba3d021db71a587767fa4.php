<?php /*a:3:{s:73:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/ucenter/coupon.php";i:1623379872;s:70:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/main/layout.php";i:1623379872;s:78:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/common/ucenter_menu.php";i:1623379872;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="member-sideright">
        ...
        <div class="order-container">
            <div class="packaging-title">
                <a <?php if($type == 1): ?>class="called"<?php endif; ?> href="<?php echo url('coupon',['type'=>'1']); ?>">未使用</a>
                <a <?php if($type == 2): ?>class="called"<?php endif; ?> href="<?php echo url('coupon',['type'=>'2']); ?>">己使用/己过期</a>
            </div>
            <div class="morder-center">
                <table cellspacing="0" cellpadding="0" class="morder-table">
                    <tr>
                        <th width="380">名称</th>
                        <th width="225">面额（元）</th>
                        <th width="210">使用条件</th>
                        <th width="225">有效期</th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlentities((isset($vo['amount']) && ($vo['amount'] !== '')?$vo['amount']:"")); ?></td>
                        <td>
                            <?php if($vo['price'] > 0): ?>
                            满 <?php echo htmlentities((isset($vo['price']) && ($vo['price'] !== '')?$vo['price']:"")); ?> 元
                            <?php else: ?>
                            无门槛
                            <?php endif; ?>
                        </td>
                        <td><?php echo htmlentities((isset($vo['end_time']) && ($vo['end_time'] !== '')?$vo['end_time']:"")); ?></td>
                    </tr>
