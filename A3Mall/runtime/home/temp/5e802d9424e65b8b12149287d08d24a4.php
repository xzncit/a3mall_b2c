<?php /*a:3:{s:77:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/ucenter/record_log.php";i:1623379872;s:70:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/main/layout.php";i:1623379872;s:78:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/common/ucenter_menu.php";i:1623379872;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="member-container clear">
    ...
    <div class="member-sideright">
        ...
        <div class="order-container">
            <div class="obder-bg"><span class="morder-title">交易记录</span></div>
                ...
                <table cellspacing="0" cellpadding="0" class="morder-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($vo['action'] == 3): ?>
                                退款
                            <?php else: if($vo['operation']==0): ?>充值<?php else: ?>提现<?php endif; ?>
                            <?php endif; ?>
                        </td>
                        <td><?php echo htmlentities($vo['amount']); ?> 元</td>
