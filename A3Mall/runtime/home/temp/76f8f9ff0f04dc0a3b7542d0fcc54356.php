<?php /*a:2:{s:72:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/article/index.php";i:1623379872;s:70:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/main/layout.php";i:1623379872;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="title-textbox">
    ...
    <a href="<?php echo htmlentities($vo['url']); ?>"><?php echo htmlentities($vo['title']); ?></a>&nbsp;<?php if(!$vo['last']): ?><em>/</em><?php endif; ?>
    <?php endforeach; endif; else: echo "" ;endif; ?>
</div>
...
<div class="member-container clear">
    <div class="help-support">
        <div class="member-sideleft">
            ...
            <div class="m-box">
                <?php if(!empty($article_menu)): if(is_array($article_menu) || $article_menu instanceof \think\Collection || $article_menu instanceof \think\Paginator): $i = 0; $__LIST__ = $article_menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <div class="member-text">
                    <div class="home-t"><?php echo htmlentities($item['title']); ?></div>
                    <div class="homt-c">
                        <ul>
                            ...
                            <li><a href="<?php echo htmlentities($v['url']); ?>"><?php echo htmlentities($v['title']); ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <?php endif; ?>
                        </ul>
                    </div>
    ...
    <div class="member-sideright">
        ...
        <div class="order-container">
            <div class="obder-bg"><span class="morder-title"><?php echo htmlentities($article_category['title']); ?></span></div>
            <div class="common-problem-box">
                <ul>
                    ...
                    <li><a href="<?php echo htmlentities($item['url']); ?>"><?php echo htmlentities($item['title']); ?></a><span><?php echo htmlentities($item['time']); ?></span></li>
                    <?php endforeach; endif; else: echo "" ;endif; else: ?>
                    <li style="text-align: center;font-size: 15px;margin-top: 10px;">暂无内容</li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
        <div class="page-wrap"><?php echo $page; ?></div>
    </div>
</div>
