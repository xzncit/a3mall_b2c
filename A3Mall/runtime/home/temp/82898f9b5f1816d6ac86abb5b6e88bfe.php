<?php /*a:3:{s:74:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/ucenter/suggest.php";i:1623379872;s:70:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/main/layout.php";i:1623379872;s:78:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/common/ucenter_menu.php";i:1623379872;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="member-container clear">
    ...
    <div class="member-sideright">
        <div class="order-container">
            <div class="obder-bg">
                <span class="morder-title">我的建议</span>
                <a href="javascript:;" class="add-prop suggest-editor" data-href="<?php echo url('suggest_editor'); ?>">添加建议</a>
            </div>
            <div class="morder-center">
                <table cellspacing="0" cellpadding="0" class="morder-table">
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo url('suggest_detail',['id'=>$vo['id']]); ?>">查看</a></td>
                    </tr>
...
<script type="text/javascript">
    layui.use(["layer","form"],function () {
        ...
        form.on('submit(layui-submit-filter)', function (data) {
            ...
            $.post('<?php echo url("suggest_update"); ?>', data.field, function (result) {
                if(result.status){
        ...
        $(".suggest-editor").on("click", function () {
