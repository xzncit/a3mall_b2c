<?php /*a:2:{s:73:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/category/index.php";i:1623379872;s:70:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/main/layout.php";i:1623379872;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="title-textbox">
    ...
    <a href="<?php echo url('category/index',['id'=>$item['id']]); ?>"><?php echo htmlentities($item['title']); ?></a><?php if($i != count($nav)): ?><em>/</em><?php endif; ?>
    <?php endforeach; endif; else: echo "" ;endif; ?>
</div>
...
<div class="list-good-wrap">
    ...
    <div class="sort-wrap">
        <ul>
            <li><a href="<?php echo url('category/index',['id'=>$category['id']]); ?>">默认排序</a></li>
            <li class="before-arrow"><span <?php if($order == 'asc' && $sort=='price'): ?>class="arrow-ico"<?php endif; ?>><a href="<?php echo url('category/index',['sort'=>'price','order'=>$order,'id'=>$category['id']]); ?>">价格</a></span></li>
            <li class="before-arrow"><span <?php if($order == 'asc' && $sort=='salt'): ?>class="arrow-ico"<?php endif; ?>><a href="<?php echo url('category/index',['sort'=>'salt','order'=>$order,'id'=>$category['id']]); ?>">销量</a></span></li>
        </ul>
    </div>
            ...
            <div class="list-wares clear">
                <ul>
                    ...
                    <div class="wares-center">
                        <span class="sold">已售 <?php echo htmlentities($vo['sale']); ?> 件</span>
