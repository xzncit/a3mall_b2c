<?php /*a:2:{s:69:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/goods/view.php";i:1623379872;s:70:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/main/layout.php";i:1623379872;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="title-textbox">
    ...
    <a href="<?php echo url('category/index',['id'=>$item['id']]); ?>"><?php echo htmlentities($item['title']); ?></a>&nbsp;<em>/</em>
    <?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="business-details-wrap clear">
    <div class="business-details-container clear">
        <div class="product-left-details">
            ...
            <div class="cosy-box">
                <div class="cosy-cent">
                    <a href="javascript:;" id="favorite-button" class="collect-ico"><?php if($data['favorite_flag']): ?>己收藏<?php else: ?>收藏商品<?php endif; ?>（<?php echo htmlentities($data['favorite_count']); ?>）</a>
                </div>
        ...
        <div class="product-right-details clear">
            <form action="<?php echo url('order/confirm'); ?>" method="post" id="goodsForm">
                ...
                <input type="hidden" name="id" value="<?php echo htmlentities($data['goods']['id']); ?>">
                ...
                <div class="details-product-center">
                    ...
                    <div class="marked-price-box clear">
                        ...
                        <div class="evtion">
                            ...
                            <span class="part-in"><a>共有<?php echo htmlentities($data['comment_count']); ?>个评价</a></span>
                        </div>
                    </div>
                    <div class="alternatives-box">
                        ...
                        <div class="regulation-join-box">
                            ...
                            <div class="join-shopping-cart">
                                ...
                                <span class="stock-text">库存<i><?php echo htmlentities($data['store_nums']); ?></i>件</span>
                            </div>
                        </div>
...
<script type="text/javascript">
    layui.use(["layer","rate"],function (){
        ...
        $("#add-cart").on("click",function (){
            ...
            $.post("<?php echo url('cart/add'); ?>",{ num : num,sku_id : sku, id : <?php echo htmlentities($data['goods']['id']); ?> },function (result){
                if(result.status){
                    getCart();
        ...
        $("#favorite-button").on("click",function (){
            $.get("<?php echo url('favorite',['id'=>$data['goods']['id']]); ?>",function(result){
                if(result.status){
        ...
        $(".report-btn").on("click",function (){
            layer.prompt({title: '举报信息', formType: 2}, function(text, index){
                $.post("<?php echo url('report',['id'=>$data['goods']['id']]); ?>",{ message : text },function (result){
                    if(result.status){
                        layer.close(index);
                        layer.msg(result.info,{ icon : 1 });
                    }else{
        ...
        <div class="product-commodity">
            ...
            <div class="product-commodity-text">
                <div class="goods-tab-box commodity-picture">
                    ...
                    <?php echo (isset($data['goods']['content']) && ($data['goods']['content'] !== '')?$data['goods']['content']:""); ?>
                </div>
                <div id="comments-list-box" class="goods-tab-box"></div>
                <script type="text/javascript">
                    $.get("<?php echo url('comments/index',['id'=>$data['goods']['id'],'type'=>'goods']); ?>",function (result){
