<?php /*a:3:{s:77:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/ucenter/cashrecord.php";i:1623379872;s:70:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/main/layout.php";i:1623379872;s:78:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/common/ucenter_menu.php";i:1623379872;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="member-container clear">
    ...
    <div class="member-sideright">
        ...
        <div class="order-container">
            <div class="morder-box  tit-bg"><span class="morder-title">提现记录</span></div>
            <div class="morder-center">
                <table cellspacing="0" cellpadding="0" class="morder-table">
                    <tr>
                        <th width="435">说明</th>
                        <th width="125">结算金额</th>
                        <th width="160">提现状态</th>
                    ...
                    <tr>
                        <td><?php echo htmlentities((isset($vo['msg']) && ($vo['msg'] !== '')?$vo['msg']:"己处理")); ?></td>
                        <td>￥<?php echo htmlentities((isset($vo['price']) && ($vo['price'] !== '')?$vo['price']:"")); ?></td>
                        <td><?php echo htmlentities((isset($vo['status']) && ($vo['status'] !== '')?$vo['status']:"")); ?></td>
                        <td><?php echo htmlentities((isset($vo['create_time']) && ($vo['create_time'] !== '')?$vo['create_time']:"")); ?></td>
                        <td><?php echo htmlentities((isset($vo['update_time']) && ($vo['update_time'] !== '')?$vo['update_time']:"")); ?></td>
                    </tr>
