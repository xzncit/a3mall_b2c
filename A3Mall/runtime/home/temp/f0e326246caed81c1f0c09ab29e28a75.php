<?php /*a:2:{s:72:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/seckill/index.php";i:1623379872;s:70:"/Users/huangjiapeng/www/A3MallPro/A3Mall/app/home/view/main/layout.php";i:1623379872;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="title-textbox">
    <a href="/">首页</a>&nbsp;<em>/</em>
    <a href="<?php echo url('seckill/index'); ?>">秒杀列表</a>
</div>
...
<div class="list-good-wrap">
    ...
    <div class="sort-wrap">
        <ul>
            <li><a href="<?php echo url('seckill/index'); ?>">默认排序</a></li>
            <li class="before-arrow"><span <?php if($order == 'asc' && $sort=='price'): ?>class="arrow-ico"<?php endif; ?>><a href="<?php echo url('seckill/index',['sort'=>'price','order'=>$order]); ?>">价格</a></span></li>
            <li class="before-arrow"><span <?php if($order == 'asc' && $sort=='salt'): ?>class="arrow-ico"<?php endif; ?>><a href="<?php echo url('seckill/index',['sort'=>'salt','order'=>$order]); ?>">销量</a></span></li>
        </ul>
    </div>
            ...
            <div class="list-wares clear">
                <ul>
                    ...
                    <div class="wares-center">
                        <span class="sold">已售 <?php echo htmlentities($vo['sum_count']); ?> 件</span>
