<?php /*a:1:{s:85:"/Users/huangjiapeng/www/A3Mall/A3Mall-GITEE/web/A3Mall/app/admin/view/login/index.php";i:1632709492;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <script src="/static/system/js/layui/layui.all.js"></script>
    ...
    <style type="text/css">
        ...
        #main { width: 100%; }
        #main .wrap { margin-top: 60px; height: 476px; background: url(/static/system/images/login-bg.png) no-repeat left center; }
            ...
            <div class="form-box">
                ...
                <form id="theForm" method="post">
                    ...
                    <div class="form-fields form-fields-code">
                        ...
                        <img src="<?php echo url('login/verify'); ?>" alt="code">
                    </div>
