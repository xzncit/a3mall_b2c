...
try {
  components = {
    ...
    mall: function() {
      return __webpack_require__.e(/*! import() | components/custom/mall */ "components/custom/mall").then(__webpack_require__.bind(null, /*! @/components/custom/mall.vue */ 533))
    },
    emptyBox: function() {
...
//
//
var loading = function loading() {__webpack_require__.e(/*! require.ensure | components/tool/loading */ "components/tool/loading").then((function () {return resolve(__webpack_require__(/*! ../../components/tool/loading */ 545));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var navbar = function navbar() {Promise.all(/*! require.ensure | components/navbar/navbar */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/navbar/navbar")]).then((function () {return resolve(__webpack_require__(/*! @/components/navbar/navbar */ 514));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { mixins: [_mescrollMixins.default], components: { loading: loading, navbar: navbar }, data: function data() {return { scrollNum: 0, isNavbar: false, isLoading: true, isError: false, navTitle: "", result: [], goods: [], customStyle: {}, moreData: {}, requestType: "mini" };}, onLoad: function onLoad() {var platformAgent = this.$utils.platformAgent();if (platformAgent.type != "h5") {this.isNavbar = true;this.navTitle = "首页";}}, onPageScroll: function onPageScroll(obj) {
