(my["webpackJsonp"] = my["webpackJsonp"] || []).push([["pages/order/detail"],{
...
var _detail = _interopRequireDefault(__webpack_require__(/*! ./pages/order/detail.vue */ 250));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _detail_vue_vue_type_template_id_57d42baa_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.vue?vue&type=template&id=57d42baa&scoped=true& */ 251);
...
/* harmony import */ var _detail_vue_vue_type_style_index_0_id_57d42baa_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./detail.vue?vue&type=style&index=0&id=57d42baa&lang=scss&scoped=true& */ 255);
...

{
  ...
  methods: {
    ...
    requestPayment: function requestPayment(orderInfo, type, orderParams) {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var that;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (
    ...
    cancel: function cancel() {var _this4 = this;
      ...
      then(function (res) {
        ...
        if (res.status) {
          ...
          _this4.$utils.navigateTo("order/list", { id: 1 });
        } else {
          _this4.$utils.msg(res.info);
        }
      }).catch(function (err) {
        _this4.$utils.hideLoading();
        _this4.$utils.msg("网络出错，请检查网络是否连接");
      });
