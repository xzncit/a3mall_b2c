...

{
  onLaunch: function onLaunch(options) {var _this = this;
    ...
    this.$http.getTemplateConfig().then(function (res) {
      if (JSON.stringify(res.data) != "{}") {
        _this.$storage.setJson('template', res.data);
      } else {
        _this.$storage.remove('template');
      }
    });
      ...
      if (users != null) {
        this.$http.autoLogin().then(function (result) {
          if (result.status === 1000) {
            ...
            _this2.$storage.remove("users");
          }
        });
      }
    },

    parseSceneParams: function parseSceneParams(option) {
      if (option.query.hasOwnProperty('scene')) {
        switch (option.scene) {
          ...
          case 1049: // 手机相册选取小程序码
            ...
            if (res.u == null || res.u == undefined || res.u <= 0) {
              return;
            }

            this.$storage.set('spread_id', res.u);}
