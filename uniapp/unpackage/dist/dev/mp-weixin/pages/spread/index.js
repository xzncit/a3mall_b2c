...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/spread/index.vue */ 453));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _index_vue_vue_type_template_id_3873472f___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=3873472f& */ 454);
  ...
  onLoad: function onLoad() {var _this = this;
    this.$http.getSpreadIndex().then(function (res) {
      if (res.status) {
        ...
        _this.amount_count = res.data.amount_count;
        _this.yesterday_amount = res.data.yesterday_amount;

        _this.switch_1 = res.data.switch_1;
